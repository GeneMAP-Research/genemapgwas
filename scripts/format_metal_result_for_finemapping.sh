...
if [ $# -lt 5 ];
then
   echo "Usage: get_snps_for_finemapping.sh [metal result (gzipped)] [chrom] [pos] [finemap size (e.g. 50000)] [output prefix] [ref (e.g. custom/hg19, kgp/hg38)]"
else
